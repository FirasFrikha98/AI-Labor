...
input_file = "../input/tweet_keyword_mapping_push_factors_environment.json"
output_file = "../output/augmented_push_factors_environment.json"

label = "push_factors_environment"
