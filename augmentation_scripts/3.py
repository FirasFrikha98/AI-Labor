...
input_file = "../input/tweet_keyword_mapping_pull_factors_political_factors.json"
output_file = "../output/augmented_pull_factors_political_factors.json"

label = "pull_factors_political_factors"
