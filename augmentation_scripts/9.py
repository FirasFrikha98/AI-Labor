...
input_file = "../input/tweet_keyword_mapping_push_factors_political.json"
output_file = "../output/augmented_push_factors_political.json"

label = "push_factors_political"
