...
output_dirs = {
    "first": "../training_data/baseline/first",
    "middle": "../training_data/baseline/middle",
    "last": "../training_data/baseline/last"
}
...
def process_class(keyword_file, augmented_file, label):
    ...
    original_tweets = [
        ...
        for entry in augmented_data if "augmentations" in entry
    ]
