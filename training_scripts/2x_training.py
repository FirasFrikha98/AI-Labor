...
# Paths to data
data_dirs = {
    "first": "../training_data/2x/first",
    "middle": "../training_data/2x/middle",
    "last": "../training_data/2x/last",
}
...
for metric, value in avg_results.items():
    if metric != "confusion_matrix":  # Exclude confusion matrix from the printout
